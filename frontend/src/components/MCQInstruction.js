    ...
    return (
        <div className="mcq-instruction-container">
            ...
            <ul>
                ...
                <li>Answer to the best of your ability. If you are unsure, you may skip the questions instead of guessing.</li>
                <li>Important: You will have 25 seconds to answer each question. If you do not answer within 25 seconds, the survey will automatically move to the next question.</li>
            </ul>
